...
public:
	...
	bool haveSameCourseID(Course* course) const;
	bool searchSameCourseID(const std::vector<Course*>&) const;
...
public:
	...
	bool haveSamePresentedCourseID(PresentedCourse* course) const;
	bool searchSamePresentedCourseID(const std::vector<PresentedCourse*>&) const;
